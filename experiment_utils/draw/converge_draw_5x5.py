...
def plot_convergence_metrics_heatmaps(file_path: str, output_path: str = None, grid_size: tuple = (5, 5)):
    """
    ...
    fig.suptitle(f'Network Convergence Analysis - 5×5 {topology_type} Topology', fontsize=16, y=0.95, fontweight='bold')
...
def plot_single_convergence_metric_heatmap(file_path: str, metric: str, output_path: str = None, grid_size: tuple = (5, 5)):
    """
    ...
    # Set title and labels
    ax.set_title(f'Network Convergence Analysis: {config["title"]} - 5×5 {topology_type} Topology', fontsize=14, pad=15, fontweight='bold')
    ax.set_xlabel('Column', fontsize=11)
    ax.set_ylabel('Row', fontsize=11)

    # Add subtitle with explanation
    plt.figtext(0.5, 0.02, f'Each cell represents a router position in 5×5 {topology_type.lower()} topology. Gray cells indicate no data.',
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 3:
        ...
        print("Usage: python converge_draw.py <csv_file_path> <output_image_path>")
