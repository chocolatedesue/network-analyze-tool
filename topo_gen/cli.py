...
def generate_grid(
    ...
    isis_spf_init_delay: int = typer.Option(100, "--isis-spf-init-delay", help="ISIS SPF初始延迟(毫秒)"),
    isis_spf_short_delay: int = typer.Option(0, "--isis-spf-short-delay", help="ISIS SPF短延迟(毫秒)"),
    isis_spf_long_delay: int = typer.Option(0, "--isis-spf-long-delay", help="ISIS SPF长延迟(毫秒)"),
    isis_spf_holddown: int = typer.Option(0, "--isis-spf-holddown", help="ISIS SPF保持延迟(毫秒)"),
    isis_spf_time_to_learn: int = typer.Option(0, "--isis-spf-time-to-learn", help="ISIS SPF学习时间(毫秒)"),
    ...
    try:
        config = TopologyConfig(
            ...
            isis_config=ISISConfig(
                ...
                spf_init_delay=isis_spf_init_delay,
                spf_short_delay=isis_spf_short_delay,
                spf_long_delay=isis_spf_long_delay,
                spf_holddown=isis_spf_holddown,
                spf_time_to_learn=isis_spf_time_to_learn,
                fast_reroute=isis_fast_convergence,
...
def generate_from_config(
    ...
    try:
        ...
        isis_cfg = ISISConfig(
            ...
            spf_init_delay=getattr(app_settings, 'isis_spf_init_delay', 100),
            spf_short_delay=getattr(app_settings, 'isis_spf_short_delay', 0),
            spf_long_delay=getattr(app_settings, 'isis_spf_long_delay', 0),
            spf_holddown=getattr(app_settings, 'isis_spf_holddown', 0),
            spf_time_to_learn=getattr(app_settings, 'isis_spf_time_to_learn', 0),
